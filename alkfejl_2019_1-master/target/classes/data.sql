...
insert into receipt (id,name,user_id,difficulty,salty,visibility) values (1,'sajtos pogácsa',1,'könnyű',true,true);
...
insert into receipt_description (id, receipt_id, description ) values (1,1,'egyeske');
